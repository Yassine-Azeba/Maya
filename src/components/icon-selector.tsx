...
export default function IconSelector({icon,setIcon}:IconSelectorProps){
    const Icons = [{label: "Folder", item: Folder},{label: "Folders", item: Folders},{label: "Archive", item: Archive},{label: "Inbox", item: Inbox},{label: "Layers", item: Layers},{label: "LayoutGrid", item: LayoutGrid},{label: "Boxes", item: Boxes},{label: "Package", item: Package},{label: "Briefcase", item: Briefcase},{label: "Settings", item: Settings},
